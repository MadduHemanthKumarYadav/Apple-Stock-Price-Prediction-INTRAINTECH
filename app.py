...
# Sample Apple stock data for the "Information" section
...
if section == "Prediction":
    ...
    # Add your code to display information about Apple stocks
    st.markdown(stock_data)

elif section == "About":
    st.header("About Us")
    # Add your code to display information about your team
